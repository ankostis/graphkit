...
"""Generic runtime utilities, mostly sequences & error handling like :term:`jetsam`.
...
.. doctest::
    ...
    >>> from graphtik.util import *
    >>> __name__ = "graphtik.util"
"""
...
def jetsam(ex, locs, *salvage_vars: str, annotation="jetsam", **salvage_mappings):
    """
    Annotate exception with salvaged values (:term:`jetsam`) from ``locals()`` and raise intact!
